#' Conjunto de datos metereologicos
#'
#' Los datos son utilizados para diferentes funciones
#'
#'
#' @format conjunto de datos con 35 columnas y 17041 filas
#' \describe{
...
#'   }
#'
#'   @source datos obtenidos de una url
